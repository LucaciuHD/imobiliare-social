...
const PROMPTS = {
  facebook: (info) => `Ești agent imobiliar profesionist la SIMPLU Imobiliare Craiova. Scrie o postare Facebook profesională și convingătoare. Începe OBLIGATORIU cu una din aceste variante: "🏠 SIMPLU Imobiliare vă prezintă cu plăcere..." sau "🏠 SIMPLU Imobiliare vă propune spre achiziție..." sau "🏠 Echipa SIMPLU Imobiliare vă prezintă...". NU folosi niciodată adresări de tipul "Dragi prieteni", "Bună ziua", "Bună" sau alte salutări. Include emoji-uri relevante și detaliile cheie. Termină cu exact: "Totul este mai SIMPLU cu noi! 😊". NU include număr de telefon, date de contact sau cuvântul "showroom". Scrie toate cuvintele complet, fără abrevieri. Max 400 cuvinte.\n\nProprietate:\n${info}`,
